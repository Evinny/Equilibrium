        ...
        <div class="container">
          <article class="title-classic">
            ...
            <div class="title-classic-text">
              <p>cadastre-se com o seu id hotmart para ter acesso a ferramenta</p>
            </div>
          </article>
          <form  method="post" action="{{route('cadastro.store')}}">
            ...
            <div class="row row-14 gutters-14">
              <div class="col-md-4">
                <div class="form-wrap">
                  <input class="form-input" id="contact-your-user-2" type="text" name="name">
                  <label class="form-label" for="contact-your-user-2">Usuario</label>
                </div>
              </div>
              <div class="col-md-4">
                <div class="form-wrap">
              ...
              <div class="col-md-4">
                <div class="form-wrap">
                  <input class="form-input" id="contact-telefone-2" type="text" name="telefone" >
                  <label class="form-label" for="contact-telefone-2">Telefone<sub style="padding: 5px; font-size: 0.8em;">(Opcional)</sub></label>
                </div>
              </div>
              <div class="col-md-4">
                <div class="form-wrap">
                  <label class="form-label" for="contact-password-2">Senha</label>
                  <input class="form-input" id="contact-password-2" type="password" name="password" >
                </div>
              </div>
              <div class="col-md-4">
                <div class="form-wrap">
                  <label class="form-label" for="contact-password-3">Repita a Senha</label>
                  <input class="form-input" id="contact-password-3" type="password" name="password_confirmation" >
                </div>
              </div>
              <div class="col-md-4">
                <div class="form-wrap">
                  <label class="form-label" for="contact-hotmart-3">ID Hotmart</label>
                  <input class="form-input" id="contact-hotmart-3" type="text" name="hotmart_id" >
                </div>
              </div>
              <br>
              <h6 style='color:rgb(205, 0, 0); background-color:rgb(255, 216, 117); padding: 2px 2px 2px 2px;'>
              @if($errors->any())
              ⚠️
                  {{$errors->first()}}
            ...
            <button class="button button-primary button-pipaluk" type="submit">Cadastrar</button>
          </form>
        </div>
      </section>
