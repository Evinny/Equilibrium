    ...
    <div class="page">
      ...
      <section class="section section-sm section-last bg-default text-left">
        <div class="container">
          ...
          <form  method="post" action="{{route('dashboard.habitos.store')}}">
            @csrf
            <div class="row row-14 gutters-14">
              <div class="col-md-4">
                <div class="form-wrap">
                  <input class="form-input" id="contact-your-user-2" type="text" name="nome">
                  <label class="form-label" for="contact-your-user-2">nome</label>
                </div>
              </div>
              <div class="col-md-4">
                <div class="form-wrap">
                  <input class="form-input" id="contact-email-2" type="text" name="categoria" >
                  <label class="form-label" for="contact-email-2">categoria</label>
                </div>
              </div>
